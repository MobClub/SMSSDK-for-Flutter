                ...
                actions: <Widget>[
                  new FlatButton(
                    ...
                    onPressed: () {
                      // 关闭弹框
                      Navigator.of(context).pop();
                      Mobcommonlib.submitPolicyGrantResult(
                          true, (dynamic ret, Map err) => {});
                    },
                  ),
                  new FlatButton(
                    child: new Text("拒绝"),
      ...
      children: <Widget>[
          ...
          child: new FlatButton(
            ...
            onPressed: () {
              Smssdk.getTextCode(phoneController.text, zoneController.text,
                      tempIDController.text)
                  .then((value) {
                if (value.err != null) {
                  showAlert(value.err.toString(), context);
                } else {
                  String rst = value.ret.toString();
                  if (rst == null || rst == "") {
                    rst = '获取验证码成功!';
                  }
        ...
        ConstrainedBox(
          ...
          child: new FlatButton(
            ...
            onPressed: () {
              Smssdk.getVoiceCode(phoneController.text, zoneController.text).then((value){
                if (value.err != null) {
                  showAlert(value.err.toString(), context);
                } else {
          ...
          child: new FlatButton(
            ...
            onPressed: () {
              Smssdk.commitCode(phoneController.text, zoneController.text,
                  codeController.text).then((value) {
                if (value.err != null) {
                  showAlert(value.err.toString(), context);
                } else {
        ...
        ConstrainedBox(
          ...
          child: new FlatButton(
            ...
            onPressed: () {
              Smssdk.getSupportedCountries().then((value){
                if (value.err != null) {
                  showAlert(value.err.toString(), context);
                } else {
                  showAlert(value.ret.toString(), context);
                }
              });
            },
          ),
        ...
        ConstrainedBox(
          ...
          child: new FlatButton(
            ...
            onPressed: () {
              Smssdk.submitUserInfo(
                  "3241241",
                  "SmsSDK_Flutter_User_3241241",
        ...
        ConstrainedBox(
          ...
          child: new FlatButton(
            ...
            onPressed: () {
              Smssdk.enableWarn(true).then((value) {
                if (value.err != null) {
                  showAlert(value.err.toString(), context);
                } else {
